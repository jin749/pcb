...
#SBATCH -J nomode_nowarm_nofilter_small    # name of job
...
conda activate pcb
config=/home/jin749/jinpcb/sbatch/none24.csv
...
MODE=none
SEED=$(awk -F '[,]' -v task_id=$SLURM_ARRAY_TASK_ID 'NR==task_id {print $3}' $config)

WANDB_PROJECT_NAME=${ALMETHOD}_mode${MODE}_warm${WARM_START}_filter${FILTER}
